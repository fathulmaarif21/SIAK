...
<head>
    ...
    <style>
        * {
        ...
        .myRightCtn {
            position: relative;
            background-image: linear-gradient(45deg, #FFCBC4, #fff);
            border-radius: 25px;
            height: 100%;
            padding: 25px;
        ...
        .myLeftCtn .butt {
            background: linear-gradient(45deg, #FFCBC4, #FF759E);
            color: #fff;
            width: 230px;
            border: none;
            border-radius: 25px;
        ...
        .myLeftCtn .butt:hover {
            background: linear-gradient(45deg, #FF759E, #FF759E);
        }
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="myRightCtn">
                        <div class="box">
                            <img src="<?= base_url('assets/'); ?>dist/img/KIYAPNG.png" class="img-fluid" alt="">
                        </div>
